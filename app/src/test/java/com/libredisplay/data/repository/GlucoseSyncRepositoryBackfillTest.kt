...
class GlucoseSyncRepositoryBackfillTest {
    ...
    @Test
    fun mergeBackfillWindowPoints_keepsDelayedPointsWithin12Hours() {
        ...
        val reading = GlucoseReading(
            ...
            history = listOf(
                GlucoseHistoryPoint(120, now.minusSeconds(13 * 3600), GlucoseTrend.FLAT),
        ...
        assertTrue(merged.none { it.timestamp == now.minusSeconds(13 * 3600) })
